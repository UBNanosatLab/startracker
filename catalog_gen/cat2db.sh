...
python -c "from gendb import *;filtermagnitude(MIN_BRIGHT);filterdoublestars(ARC_PER_PIX*4);nearstars();fovstars()" | sort -u -t " " -n -k1,1n -k 2,2n -k3,3n -k4,4n > unprocessed.dat
echo "done"
