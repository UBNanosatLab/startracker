...
sphere2cube starmap.png -R 0 0 0 -t 16 -r $hs -f PNG
...
scp face_4_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/ft.png
scp face_1_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/rt.png
scp face_2_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/bk.png
scp face_3_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/lt.png
scp face_5_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/dn.png
scp face_6_$hs.png andrew@diablo:~/startracker/camera_simulator/Data_$hs/up.png
